...
As we can see below I create and unmanaged VMs and the VM is  unmanaged now and we can see all the unmanaged instances using list unmanage instances api
